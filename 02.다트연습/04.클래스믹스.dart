...
void main() {
// 테슬라 자동차 인스턴스 생성하기
// new Tesla() 인스턴스 생성시 new 키워드 생략 가능
  ...
  // Tesla 클래스 자신에게 없는 정보 = 믹스인 클래스 정보
  print('🚐엔진정보: ${tesla.power}마력');
  print('🚐바퀴정보: ${tesla.wheelInfo}');
  print('🚐라이트정보: ${tesla.luminosity}lux');

  // 믹스인 키워드만으로 생성된 클래스는 인스턴스화가 되는가?
  // Engine eng = Engine(); => 인스턴스화 불가
  // mixin 키워드만으로도 만든 클래스는 부품같은 느낌이다
  // 믹스인도 되고 인스턴스로 생성되려면 믹스인 mixin class 클래스명{} 이렇게 생성
  Light light = Light();

  print('개별 인스턴스 광도 : ${light.luminosity}lux');
